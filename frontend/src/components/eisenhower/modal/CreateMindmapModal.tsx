...
export function CreateMindmapModal({ isOpen, onClose, onCreate }: CreateMindmapModalProps) {
    ...
    >
      <DialogContent className="sm:max-w-[480px] p-0 overflow-hidden rounded-xl">
        <div className="bg-white p-6">
          ...
          <div className="mb-4">
            <label className="block mb-1 text-sm font-medium">마인드맵 주제</label>
            <input
              type="text"
          ...
          <div className="mb-6">
            <label className="block mb-1 text-sm font-medium">마인드맵 타입</label>
              ...
              {(["Todo", "Thinking"] as const).map((t) => (
                <button
                  ...
                  className={`flex-1 py-2 rounded-md border text-sm font-medium ${
                    type === t ? "border-purple-500 text-purple-600" : "border-gray-300 text-gray-500"
                  }`}
                >
                  {t}
                </button>
          ...
          <div className="flex justify-end">
            <button
              ...
              className={`w-full py-2 rounded-md text-white font-medium ${
                title.trim() ? "bg-black hover:bg-gray-800" : "bg-gray-300 cursor-not-allowed"
              }`}
            >
              생성하기
            </button>
