...
export const TypeBadge = ({ type, withDot = true, className }: TypeBadgeProps) => {
  ...
  return (
    <Badge
      variant="outline"
      className={cn("inline-flex items-center text-xs font-medium px-2 py-0.5 rounded-full", colorClass, className)}
    >
